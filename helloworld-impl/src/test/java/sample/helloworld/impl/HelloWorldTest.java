...
public class HelloWorldTest {
  ...
  public void testHelloWorld() {
    PersistentEntityTestDriver<HelloCommand, HelloEvent, WorldState> driver = new PersistentEntityTestDriver<>(system, new HelloWorld(), "world-1");
    ...
    Outcome<HelloEvent, WorldState> outcome2 = driver.run(new UseGreetingMessage("Hi"), new Hello("Bob", Optional.empty()));
